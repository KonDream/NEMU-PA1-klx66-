...
make_group(group1_b,
	...
	inv, /*sub_i2rm_b*/inv, inv, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, inv, inv, inv, 
	inv, /*sub_i2rm_v*/inv, inv, cmp_i2rm_v)

/* 0x83 */
make_group(group1_sx_v,
	add_si2rm_v, inv, inv, inv, 
	inv, /*sub_si2rm_v*/inv, inv, cmp_si2rm_v)
...
/* 0x28 */	/*sub_r2rm_b, sub_r2rm_v, sub_rm2r_b, sub_rm2r_v*/inv, inv, inv, inv,
/* 0x2c */	/*sub_i2a_b, sub_i2a_v*/inv, inv, inv, inv,
