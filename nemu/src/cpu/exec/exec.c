...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, adc_i2rm_b, xor_i2rm_b, or_i2rm_b, 
	and_i2rm_b, sub_i2rm_b, inv, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, adc_i2rm_v, xor_i2rm_v, or_i2rm_v, 
	and_i2rm_v, sub_i2rm_v, inv, cmp_i2rm_v)

/* 0x83 */
make_group(group1_sx_v,
	add_si2rm_v, adc_si2rm_v, xor_si2rm_v, or_si2rm_v, 
	and_si2rm_v, sub_si2rm_v, inv, cmp_si2rm_v)

/* 0xc0 */
make_group(group2_i_b,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_imm_b, sar_rm_imm_b)

/* 0xc1 */
make_group(group2_i_v,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_imm_v, sar_rm_imm_v)

/* 0xd0 */
make_group(group2_1_b,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_1_b, sar_rm_1_b)

/* 0xd1 */
make_group(group2_1_v,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_1_v, sar_rm_1_v)

/* 0xd2 */
make_group(group2_cl_b,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_cl_b, sar_rm_cl_b)

/* 0xd3 */
make_group(group2_cl_v,
	inv, inv, inv, inv, 
	inv, inv, shl_rm_cl_v, sar_rm_cl_v)
